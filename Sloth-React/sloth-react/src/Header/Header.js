...
<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-success mb-3">
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <NavDropdown.Item href="#action/3.2" onClick={props.AddStock}>Add Stock</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.3"  onClick={props.TransferStock}>Transfer Stock</NavDropdown.Item>
                </NavDropdown>
            </ul>
        </div>
    </nav>
